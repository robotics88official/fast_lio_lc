...
void Preprocess::oust64_handler(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
{
  ...
  {
    double time_stamp = msg->header.stamp.sec + msg->header.stamp.nanosec / 1E9;
    // cout << "===================================" << endl;
...
void Preprocess::velodyne_sim_handler(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
    pl_surf.clear();
